...
The importance of replication in science has been legitimately supported during recent years [e.g., @open_science_collab_2015; @baker_reproducibility_2016; @brandt_et_al_replication_2014]. However, most of the attention has been focused on exact, or close replications, that is, replications concerned with the statistical reliability of the results. The effects estimated in these replications can be pooled, eventually with other studies with a similar design, by means of meta-analysis or Bayesian sequential updating, so that a researcher is able to obtain a more precise estimate of the population parameter of interest. Although the initiative to directly replicate and combine similar studies is commendable, 
